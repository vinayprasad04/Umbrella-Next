  ...
  return (
    <>
      ...
      <div className="font-sans m-0 p-0 bg-white dark:bg-gray-900 transition-colors duration-300">
        ...
        {/* Main Login Section */}
        <div className="relative min-h-screen bg-gradient-to-br from-gray-50 via-white to-orange-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 overflow-hidden">
            ...
            <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex justify-center lg:justify-end">
                <div className="w-full ">
                  {/* Login Card */}
                  <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/20 transition-colors duration-300 p-8 md:p-10">
                    {/* Header */}
                    <div className="text-center mb-8">
                      ...
                      <p className="text-gray-600 dark:text-gray-300">Sign in to access your financial dashboard</p>
                    </div>
                    ...
                    {googleError && (
                      <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 transition-colors duration-300 text-red-700 dark:text-red-300 px-4 py-3 rounded-xl mb-6 text-sm">
                        {googleError}
                      </div>
                    )}
                    ...
                    <div className="flex items-center gap-4 my-6">
                      ...
                      <span className="text-sm text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 px-3 py-1 rounded-full border border-gray-200 dark:border-gray-700">or continue with email</span>
                      <div className="flex-1 h-px bg-gradient-to-r from-transparent via-gray-300 dark:via-gray-600 to-transparent"></div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div className="space-y-1">
                        ...
                        <div className="relative">
                          <input
                            ...
                            className={`w-full border-2 rounded-xl px-4 py-4 pl-12 text-gray-900 dark:text-gray-200 bg-white dark:bg-gray-700/50 backdrop-blur-sm focus:outline-none focus:border-[#FF6B2C] focus:ring-4 focus:ring-[#FF6B2C]/10 transition-all duration-300 ${errors.email ? 'border-red-400 focus:border-red-400 focus:ring-red-100' : 'border-gray-200 dark:border-gray-700'}`}
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="relative">
                          <input
                            ...
                            className={`w-full border-2 rounded-xl px-4 py-4 pl-12 text-gray-900 dark:text-gray-200 bg-white dark:bg-gray-700/50 backdrop-blur-sm focus:outline-none focus:border-[#FF6B2C] focus:ring-4 focus:ring-[#FF6B2C]/10 transition-all duration-300 ${errors.password ? 'border-red-400 focus:border-red-400 focus:ring-red-100' : 'border-gray-200 dark:border-gray-700'}`}
                      ...
                      {loginError && (
                        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 transition-colors duration-300 text-red-700 dark:text-red-300 px-4 py-3 rounded-xl text-sm flex items-center gap-2">
              ...
              <div className="hidden lg:flex flex-col items-center justify-center text-center space-y-8">
                ...
                <div className="max-w-lg space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-6 pt-4">
                    <div className="text-center p-4 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl border border-white/30 dark:border-gray-600/30 transition-colors duration-300">
                      <div className="text-2xl font-bold text-[#FF6B2C] mb-1">25+</div>
                      <div className="text-sm text-gray-600 dark:text-gray-300">Financial Tools</div>
                    </div>
                    <div className="text-center p-4 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl border border-white/30 dark:border-gray-600/30 transition-colors duration-300">
