          ...
          <div className="w-1/2 bg-white border-r border-gray-200 overflow-y-auto flex flex-col">
            ...
            <div className="bg-white border-b border-gray-200 py-6 px-6">
              ...
              <div className="text-xs text-gray-400 mb-4 flex items-center gap-1">
                ...
                <span className="text-[#FF6B2C] font-semibold">House Planning</span>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-2xl font-bold text-black mb-1">House Planning</div>
                  <div className="text-sm text-gray-500">Plan your dream house purchase with comprehensive financial planning.</div>
                </div>
              </div>
            </div>
