                  ...
                  {activeTab === 'account' && (
                    <div className="space-y-6">
                      ...
                      <button
                        ...
                        className="w-full md:w-auto bg-gradient-to-r from-purple-600 to-orange-500 hover:from-purple-700 hover:to-orange-600 text-white px-8 py-4 rounded-xl font-bold transition-all transform hover:scale-105 shadow-xl text-lg"
                      >
                        💾 Save Changes
                      </button>
                    </div>
