...
const ForgotPassword = () => {
  ...
  return (
    <>
      <Head>
        <title>Forgot Password - Umbrella Financial</title>
        <meta name="description" content="Reset your Umbrella Financial account password securely and get back to managing your investments" />
                    ...
                    {isSubmitted ? (
                      ...
                      <>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                          ...
                          <button 
                            type="submit" 
                            className="group w-full bg-gradient-to-r from-[#FF6B2C] to-[#FF8A50] hover:from-[#e55d1f] hover:to-[#e67a44] text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 hover:shadow-xl hover:shadow-orange-500/25 hover:scale-105 flex items-center justify-center gap-2"
                          >
