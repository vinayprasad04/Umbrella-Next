...
const CreateBlog = () => {
  ...
  const handlePublish = async () => {
    const publishData = { ...formData, status: 'live' as const };
    setFormData(publishData);
    
    // Trigger form submission with live status
    const formEvent = new Event('submit') as any;
    formEvent.preventDefault = () => {};
    handleSubmit(formEvent);
  };
                        ...
                        <div className="border-t pt-4">
                          <div className="flex flex-col gap-2">
                            <button
                              ...
                              className="w-full bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-lg disabled:opacity-50"
                            >
