            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-4 md:p-6 lg:p-8 prose max-w-none">
                <section className="mb-4 md:mb-6">
                  <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 mb-3 md:mb-4">Agreement to Terms</h2>
                ...
                <section className="mb-4 md:mb-6">
                  <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 mb-3 md:mb-4">Use License</h2>
                  <p className="text-sm md:text-base text-gray-700 mb-3 md:mb-4">
                ...
                <section className="mb-4 md:mb-6">
                  <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 mb-3 md:mb-4">Financial Disclaimer</h2>
                  <p className="text-sm md:text-base text-gray-700 mb-3 md:mb-4">
                ...
                <section className="mb-4 md:mb-6">
                  <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 mb-3 md:mb-4">User Accounts</h2>
                  <p className="text-sm md:text-base text-gray-700 mb-3 md:mb-4">
                ...
                <section className="mb-4 md:mb-6">
                  <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 mb-3 md:mb-4">Prohibited Uses</h2>
                  <p className="text-sm md:text-base text-gray-700 mb-3 md:mb-4">You may not use our service:</p>
                  <ul className="list-disc pl-6 text-sm md:text-base text-gray-700 space-y-1 md:space-y-2">
                ...
                <section className="mb-4 md:mb-6">
                  <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 mb-3 md:mb-4">Limitation of Liability</h2>
                  <p className="text-sm md:text-base text-gray-700 mb-3 md:mb-4">
                ...
                <section className="mb-4 md:mb-6">
                  <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 mb-3 md:mb-4">Accuracy of Materials</h2>
                ...
                <section className="mb-4 md:mb-6">
                  <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 mb-3 md:mb-4">Modifications</h2>
                  <p className="text-sm md:text-base text-gray-700">
                ...
                <section className="mb-4 md:mb-6">
                  <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 mb-3 md:mb-4">Commercial Use and Profit Sharing</h2>
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 md:p-5 lg:p-6 mb-4 md:mb-5 lg:mb-6">
                    <h3 className="text-base md:text-lg font-semibold text-yellow-800 mb-2 md:mb-3">⚠️ Important Commercial Use Terms</h3>
                    <p className="text-sm md:text-base text-gray-700 mb-3 md:mb-4">
                  ...
                  <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-2 md:mb-3">Commercial Use Definition</h3>
                  <p className="text-sm md:text-base text-gray-700 mb-3 md:mb-4">Commercial use includes but is not limited to:</p>
                  <ul className="list-disc pl-6 text-sm md:text-base text-gray-700 mb-3 md:mb-4 space-y-1 md:space-y-2">
                  ...
                  <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-2 md:mb-3">Enforcement</h3>
                  <p className="text-sm md:text-base text-gray-700 mb-3 md:mb-4">
                ...
                <section className="mb-4 md:mb-6">
                  <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 mb-3 md:mb-4">Governing Law</h2>
                  <p className="text-sm md:text-base text-gray-700">
                ...
                <section className="mb-4 md:mb-6">
                  <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 mb-3 md:mb-4">Contact Information</h2>
                  <p className="text-sm md:text-base text-gray-700 mb-3 md:mb-4">
