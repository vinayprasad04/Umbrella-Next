          ...
          <section className="relative py-8 md:py-12 lg:py-16 xl:py-20 bg-gradient-to-br from-gray-50 via-white to-emerald-50 overflow-hidden">
            ...
            <div className="relative w-full max-w-[1600px] mx-auto px-6 text-center">
              <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-emerald-50 to-green-50 rounded-full border border-emerald-200 mb-3 md:mb-4 lg:mb-6">
                <span className="text-sm font-semibold text-emerald-600">👧 Sukanya Samriddhi Yojana Calculator</span>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3 md:gap-5 lg:gap-8 max-w-2xl mx-auto">
                <div className="text-center">
                  <div className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-800 mb-1">8.2%</div>
                ...
                <div className="text-center">
                  <div className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-800 mb-1">₹1.5L</div>
                  <div className="text-xs md:text-sm text-gray-600">Max Annual Deposit</div>
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="w-full max-w-[1600px] mx-auto px-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-5 lg:gap-8">
                <div className="group bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
                  ...
                  <p className="text-gray-600">Complete EEE status - deposits, interest, and maturity all tax-free</p>
                </div>

                <div className="group bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
                  <h3 className="text-xl font-bold text-gray-800 mb-4">High Interest Rate</h3>
                  <p className="text-gray-600">Currently offering 8.2% interest rate - higher than most savings schemes</p>
                </div>

                <div className="group bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
                  <h3 className="text-xl font-bold text-gray-800 mb-4">Flexible Withdrawals</h3>
                  <p className="text-gray-600">Partial withdrawal allowed after age 18 for education expenses</p>
                </div>
              </div>
            </div>
          </section>
