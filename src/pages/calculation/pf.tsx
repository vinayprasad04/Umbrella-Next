          ...
          <section className="relative py-8 md:py-12 lg:py-16 xl:py-20 bg-gradient-to-br from-gray-50 via-white to-emerald-50 overflow-hidden">
            ...
            <div className="relative w-full max-w-[1600px] mx-auto px-6 text-center">
              <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-emerald-50 to-green-50 rounded-full border border-emerald-200 mb-3 md:mb-4 lg:mb-6">
                <span className="text-sm font-semibold text-emerald-600">💼 Provident Fund Calculator</span>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3 md:gap-5 lg:gap-8 max-w-2xl mx-auto">
                <div className="text-center">
                  <div className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-800 mb-1">Tax-Free</div>
                  <div className="text-xs md:text-sm text-gray-600">Returns</div>
                </div>
                <div className="text-center">
                  <div className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-800 mb-1">8.1%</div>
                  <div className="text-xs md:text-sm text-gray-600">Interest Rate</div>
                </div>
                <div className="text-center">
                  <div className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-800 mb-1">Retirement</div>
                  <div className="text-xs md:text-sm text-gray-600">Security</div>
                </div>
              </div>
            </div>
          </section>
                    ...
                    {result ? (
                      <div className="space-y-6">
                        <div className="bg-white/80 rounded-2xl p-6 shadow-lg">
                          <div className="text-center">
                            <div className="text-sm text-gray-600 mb-2">Total PF Corpus</div>
                        ...
                        <div className="bg-blue-50 rounded-xl p-4 border border-blue-200">
                          <h4 className="font-semibold text-blue-800 mb-2">💡 EPF Benefits:</h4>
            ...
            <div className="w-full max-w-[1600px] mx-auto px-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-5 lg:gap-8">
                <div className="group bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
                  <h3 className="text-xl font-bold text-gray-800 mb-4">Tax-Free Returns</h3>
                  <p className="text-gray-600">Entire corpus including interest is tax-free at maturity</p>
                </div>

                <div className="group bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
                  <h3 className="text-xl font-bold text-gray-800 mb-4">Employer Contribution</h3>
                  <p className="text-gray-600">Get matching contribution from employer up to 12%</p>
                </div>

                <div className="group bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
                  <h3 className="text-xl font-bold text-gray-800 mb-4">Loan Facility</h3>
                  <p className="text-gray-600">Avail loans for housing, education, and medical emergencies</p>
                </div>
              </div>
            </div>
          </section>
